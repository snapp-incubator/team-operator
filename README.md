...
```bash
make build   # standard build, no external dependencies
```

See [CONTRIBUTING.md](CONTRIBUTING.md) for details on the optional real-time IAM
admin watch feature and its build requirements.
