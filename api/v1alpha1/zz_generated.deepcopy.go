...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TeamWebhookOptions) DeepCopyInto(out *TeamWebhookOptions) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TeamWebhookOptions.
func (in *TeamWebhookOptions) DeepCopy() *TeamWebhookOptions {
	if in == nil {
		return nil
	}
	out := new(TeamWebhookOptions)
	in.DeepCopyInto(out)
	return out
}
